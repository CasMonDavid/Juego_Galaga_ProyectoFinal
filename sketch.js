...
function preload(){// función para cargar multimedia
  img_naveJugador = loadImage('Juego_Galaga_ProyectoFinal/assets/nave_jugador.png');
  img_enemigo_tipo1 = loadImage('Juego_Galaga_ProyectoFinal/assets/enemigo_tipo1.png');
  img_enemigo_tipo2 = loadImage('Juego_Galaga_ProyectoFinal/assets/enemigo_tipo2.png');
  img_enemigo_tipo_boss = loadImage('Juego_Galaga_ProyectoFinal/assets/enemigo_tipo_boss.png');

  soundFormats('mp3');
  sound_disparo_laser = loadSound('Juego_Galaga_ProyectoFinal/assets/sound/disparo_laser.mp3');
  sound_nave_explosion = loadSound('Juego_Galaga_ProyectoFinal/assets/sound/nave_explosion.mp3');
  sound_boss_explosion = loadSound('Juego_Galaga_ProyectoFinal/assets/sound/boss_explosion.mp3');
  sound_disparo_laser_enemigo = loadSound('Juego_Galaga_ProyectoFinal/assets/sound/disparo_laser_enemigo.mp3');
  sound_muerte_jugador = loadSound('Juego_Galaga_ProyectoFinal/assets/sound/muerte_jugador.mp3');
}
